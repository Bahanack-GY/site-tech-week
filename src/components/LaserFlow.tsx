...
const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    const onCtxLost = (e: WebGLContextEvent) => {
      e.preventDefault();
    ...
    return () => {
      ...
      // Explicit type casting to remove listener correctly
      ...
      canvas.removeEventListener('webglcontextlost', onCtxLost as any);
      canvas.removeEventListener('webglcontextrestored', onCtxRestored as any);
      geometry.dispose();
      material.dispose();
      renderer.dispose();
